    ...
    computed: {
        ...
        idTypeOptions() {
            return [
                ...
                { value: 'HK_MACAO_PERMIT', label: this.$t('idUpload.idTypeOptions.hkMacaoPermit') },
                { value: 'TAIWAN_PERMIT', label: this.$t('idUpload.idTypeOptions.taiwanPermit') },
                { value: 'RESIDENCE_PERMIT', label: this.$t('idUpload.idTypeOptions.residencePermit') },
                { value: 'MILITARY_ID', label: this.$t('idUpload.idTypeOptions.militaryId') },
                // { value: 'TEMP_ID', label: this.$t('idUpload.idTypeOptions.tempId') },
                // { value: 'HOUSEHOLD_REGISTER', label: this.$t('idUpload.idTypeOptions.householdRegister') },
                // { value: 'DRIVER_LICENSE', label: this.$t('idUpload.idTypeOptions.driverLicense') },
                // { value: 'OFFICER_ID', label: this.$t('idUpload.idTypeOptions.officerId') },
                // { value: 'POLICE_ID', label: this.$t('idUpload.idTypeOptions.policeId') },
                // { value: 'SOLDIER_CARD', label: this.$t('idUpload.idTypeOptions.soldierCard') },
                // { value: 'SEAFARER_ID', label: this.$t('idUpload.idTypeOptions.seafarerId') },
                // { value: 'BIRTH_CERTIFICATE', label: this.$t('idUpload.idTypeOptions.birthCertificate') },
                // { value: 'STUDENT_ID', label: this.$t('idUpload.idTypeOptions.studentId') },
                // { value: 'SOCIAL_SECURITY_CARD', label: this.$t('idUpload.idTypeOptions.socialSecurityCard') },
                // { value: 'FOREIGN_PASSPORT', label: this.$t('idUpload.idTypeOptions.foreignPassport') },
                // { value: 'HK_RESIDENCE_PERMIT', label: this.$t('idUpload.idTypeOptions.hkResidencePermit') },
                // { value: 'MACAO_RESIDENCE_PERMIT', label: this.$t('idUpload.idTypeOptions.macaoResidencePermit') },
                // { value: 'TAIWAN_RESIDENCE_PERMIT', label: this.$t('idUpload.idTypeOptions.taiwanResidencePermit') },
                // { value: 'FOREIGN_RESIDENCE_PERMIT', label: this.$t('idUpload.idTypeOptions.foreignResidencePermit') },
                // { value: 'FOREIGNER_PERMANENT_RESIDENCE', label: this.$t('idUpload.idTypeOptions.foreignerPermanentResidence') },
                // { value: 'TRAVEL_DOCUMENT', label: this.$t('idUpload.idTypeOptions.travelDocument') },
                // { value: 'RETURN_HOME_PERMIT', label: this.$t('idUpload.idTypeOptions.returnHomePermit') },
                // { value: 'TEMP_TRAVEL_PERMIT', label: this.$t('idUpload.idTypeOptions.tempTravelPermit') },
                // { value: 'MARITAL_CERTIFICATE', label: this.$t('idUpload.idTypeOptions.maritalCertificate') },
                // { value: 'HOUSE_PROPERTY_CERT', label: this.$t('idUpload.idTypeOptions.housePropertyCert') },
                // { value: 'OTHER_ID', label: this.$t('idUpload.idTypeOptions.otherId') },
                { value: 'OTHER', label: this.$t('idUpload.idTypeOptions.other') }
            ];
        },
        isFormValid() {
        ...
        validateField(fieldName) {
            ...
            switch (fieldName) {
                ...
                case 'idNumber':
                    ...
                    } else if (this.formData.idType) {
                        if (!/^[A-Z0-9]{4,20}$/i.test(this.formData.idNumber)) {
                            this.errors.idNumber = this.$t('idUpload.errors.idNumberInvalid');
                        }
                    }
                    break;
