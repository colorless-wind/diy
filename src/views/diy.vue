...
// 贴纸
  .Sticker_box{
    .header{
      ...
      .text.active1,.text.active2,.text.active3{
        color: #FF8D05;
      }
      .anmation_line{
        position: absolute;
...
/deep/.line-e {
  ...
  display: inline-block;
  border-right: 1px dashed red;/*no*/
  position: absolute;
  top: 5%;
  right: 3.27%;
  cursor: e-resize;
...
/deep/.line-s {
  ...
  height: 1px;
  display: inline-block;
  border-bottom: 1px dashed red;/*no*/
  position: absolute;
  bottom: 5%;
  left: 3.27%;
  cursor: s-resize;
  ...
  <div class="faDiv">
        ...
        <div class="Template_box">
            ...
            <div class="template" @touchmove.prevent>
                <div @click="closebox" class="img_box" id="html2canvas"  ref="imageWrapper">
                    ...
                    @mouseup="end"
                    @touchend="end"
                    @click.prevent="chooseclass"
                    v-for="(item,index) in imgarr" :src="item.photoUrl" :class="item.classname" :style="item.style" :key="index">
                    <img :src="imgback_arr.photoUrl" :class="imgback_arr.classname" :style="imgback_arr.style">
                    <!-- 选择框 -->  
                    <div class="choosebox" v-show="isshow">
                      <div class="detale" @click="removechild"><svg t="1603762355703" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1773" width="200" height="200"><path d="M 512 512 m -255.737 0 a 255.737 255.737 0 1 0 511.475 0 a 255.737 255.737 0 1 0 -511.475 0 Z" fill="#ffffff" p-id="1774"></path><path d="M 637.311 422.492 L 419.935 639.868 c -10.2294 10.2294 -25.5737 10.2294 -35.8032 0 c -10.2294 -10.2294 -10.2294 -25.5737 0 -35.8032 l 217.378 -217.378 c 10.2294 -10.2294 25.5737 -10.2294 35.8032 0 c 10.2294 7.67216 10.2294 25.5737 0 35.8032 Z" fill="#3e424b" p-id="1775"></path><path d="M 386.689 422.492 l 217.378 217.378 c 10.2294 10.2294 25.5737 10.2294 35.8032 0 c 10.2294 -10.2294 10.2294 -25.5737 0 -35.8032 L 422.492 386.689 c -10.2294 -10.2294 -25.5737 -10.2294 -35.8032 0 c -10.2294 7.67216 -10.2294 25.5737 0 35.8032 Z" fill="#3e424b" p-id="1776"></path></svg></div>
                      <div class="close" @click="copy_element"><svg t="1603763457843" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2245" width="200" height="200"><path d="M 512 512 m -315.298 0 a 315.298 315.298 0 1 0 630.593 0 a 315.298 315.298 0 1 0 -630.593 0 Z" fill="#ffffff" p-id="2246"></path><path d="M 307.058 496.234 h 189.178 v 31.5298 h -189.178 Z M 600.283 401.647 h -37.8355 V 385.881 c 15.7648 0 25.2238 0 37.8355 -15.7648 v 31.5298 Z" fill="#17191d" p-id="2247"></path><path d="M 385.881 417.41 h 31.5298 v 189.178 H 385.881 Z M 600.283 370.117 H 638.119 v 283.768 h -37.8355 Z" fill="#17191d" p-id="2248"></path></svg></div>
                      <div class="scale"
                      @mousedown="s_down"
                      @touchstart="s_down"
                      @mousemove="s_move"
                      @touchmove.prevent="s_move"
                      @mouseup="s_end"
                      @touchend="s_end"
                      ><svg t="1603762381784" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2056" width="200" height="200"><path d="M 512 512 m -255.737 0 a 255.737 255.737 0 1 0 511.475 0 a 255.737 255.737 0 1 0 -511.475 0 Z" fill="#ffffff" p-id="2057"></path><path d="M 522.229 691.015 c -15.3441 0 -25.5737 -10.2294 -25.5737 -25.5737 s 10.2294 -25.5737 25.5737 -25.5737 c 71.6065 0 127.868 -56.2621 127.868 -127.868 s -56.2621 -127.868 -127.868 -127.868 s -127.868 56.2621 -127.868 127.868 c 0 15.3441 -10.2294 25.5737 -25.5737 25.5737 s -25.5737 -10.2294 -25.5737 -25.5737 c 0 -99.7362 79.2781 -179.015 179.015 -179.015 s 179.015 79.2781 179.015 179.015 s -79.2781 179.015 -179.015 179.015 Z" fill="#41444d" p-id="2058"></path><path d="M 384.132 583.607 l 56.2621 -94.6223 c 2.55737 -2.55737 0 -7.67216 -5.11474 -7.67216 l -132.984 15.3441 c -5.11474 0 -5.11474 5.11474 -2.55737 7.67216 l 76.7217 79.2781 c 2.55737 2.55737 5.11474 2.55737 7.67216 0 Z" fill="#41444d" p-id="2059"></path></svg></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="Sticker_box">
      <div class="header">
        ...
        <div :class="{'active1':Sticker_type==0,'active2':Sticker_type==1,'active3':Sticker_type==2}" class="anmation_line"></div>
      </div>
    ...
    <div v-show='isbackimg' class="backimg_box">
      ...
      <div id="cardCover">
        ...
        <div class="backimg_box_btn">
          <svg @click="backimg_back" t="1600855585333" class="icon file_svg_back" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11995" width="200" height="200"><path d="M877.216 491.808" p-id="11996" fill="#515151"></path><path d="M575.328 510.496 946.784 140.672c17.568-17.504 17.664-45.824 0.192-63.424-17.504-17.632-45.792-17.664-63.36-0.192L512.032 446.944 143.712 77.216C126.304 59.712 97.92 59.648 80.384 77.12 62.848 94.624 62.816 123.008 80.288 140.576l368.224 369.632L77.216 879.808c-17.568 17.504-17.664 45.824-0.192 63.424 8.736 8.8 20.256 13.216 31.776 13.216 11.424 0 22.848-4.352 31.584-13.056l371.36-369.696 371.68 373.088C892.192 955.616 903.68 960 915.168 960c11.456 0 22.912-4.384 31.648-13.088 17.504-17.504 17.568-45.824 0.096-63.392L575.328 510.496 575.328 510.496zM575.328 510.496" p-id="11997" fill="#515151"></path></svg>
          <svg @click="backimg_get" t="1600855637259" class="icon file_svg_get" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="13036" width="200" height="200"><path d="M349.372356 879.102519L1.047626 530.763339l61.30417-61.30417 287.02056 287.027785 607.47122-607.45677 61.296945 61.30417z" fill="#515151" p-id="13037"></path></svg>
        </div>
      </div>
    </div>
