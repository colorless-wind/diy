export default {
  ...
  idUpload: {
    ...
    idTypeOptions: {
      ...
      passport: 'Pasaporte',
      hkMacaoPermit: 'Permiso de Hong Kong/Macao',
      taiwanPermit: 'Permiso de Taiwán',
      residencePermit: 'Documento de residencia permanente',
      tempId: 'Documento de identidad temporal',
      householdRegister: 'Registro de hogar',
      driverLicense: 'Licencia de conducir',
      militaryId: 'Documento militar',
      officerId: 'Documento de oficial',
      policeId: 'Documento de policía',
      soldierCard: 'Carné de soldado',
      seafarerId: 'Documento de marinero',
      birthCertificate: 'Certificado de nacimiento',
      studentId: 'Carné de estudiante',
      socialSecurityCard: 'Tarjeta de seguridad social',
      foreignPassport: 'Pasaporte extranjero',
      hkResidencePermit: 'Permiso de residencia de Hong Kong',
      macaoResidencePermit: 'Permiso de residencia de Macao',
      taiwanResidencePermit: 'Permiso de residencia de Taiwán',
      foreignResidencePermit: 'Permiso de residencia para extranjeros',
      foreignerPermanentResidence: 'Documento de residencia permanente para extranjeros',
      travelDocument: 'Documento de viaje',
      returnHomePermit: 'Permiso de retorno al hogar',
      tempTravelPermit: 'Permiso de viaje temporal',
      maritalCertificate: 'Certificado de matrimonio',
      housePropertyCert: 'Certificado de propiedad de vivienda',
      otherId: 'Otro documento válido',
      other: 'Otro'
    },
    idNumber: 'Número de identificación',
    idNumberPlaceholder: 'Introduce tu número de identificación',
    ...
    phoneCountryOptions: {
      ...
      mexico: 'México +52',
      uae: 'EAU +971',
      saudi: 'Arabia Saudí +966',
      southAfrica: 'Sudáfrica +27'
    },
    ...
    errors: {
      ...
      phoneRequired: 'Introduce tu número de teléfono',
      phoneInvalid: 'Introduce un número de teléfono válido',
      countryCodeRequired: 'Selecciona el código internacional',
